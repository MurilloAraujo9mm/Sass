<?php use Source\Models\CafeApp\AppWallet;
        ...
        <section class="app_main_right">
            ...
            <article
                ...
                <header class="app_flex_title">
                    <h2 class="icon-money radius"><?= (session()->has("walletfilter") ? (new AppWallet())->findById(session()->walletfilter)->wallet : "Saldo Geral"); ?></h2>
                </header>
